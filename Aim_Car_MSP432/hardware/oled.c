...
void OLED_ShowOpenMV(void)
{
	Oled_go=0;
  if(Oled_go==0)
  {
    OLED_Clear();
    OLED_ShowString(1,0,(uint8_t *)"Mode:",16);
		char strInt[10];
	  sprintf( strInt, "%d", Mode );
    OLED_ShowString(120,0,(uint8_t *)strInt,16);
		
    OLED_ShowString(1,2,(uint8_t *)"status:",16);
	  sprintf( strInt, "%d", status );
    OLED_ShowString(120,2,(uint8_t *)strInt,16); 
		
		OLED_ShowString(1,4,(uint8_t *)"Stop_line:",16);
	  sprintf( strInt, "%d", Stop_line );
    OLED_ShowString(120,4,(uint8_t *)strInt,16);
		
		OLED_ShowString(1,6,(uint8_t *)"OpenMV_thing:",16);
    switch (Get_OpenMV_thing)
    {
      case 5:
        OLED_ShowString(120,6,(uint8_t * )"A",16);
        break;
      case 6:
        OLED_ShowString(120,6,(uint8_t *)"B",16);
        break;
      case 7:
        OLED_ShowString(120,6,(uint8_t *)"C",16);
        break;
      case 8:
        OLED_ShowString(120,6,(uint8_t *)"D",16);
        break;
      default:
      {
	      sprintf( strInt, "%d", Get_OpenMV_thing );
        OLED_ShowString(120,6,(uint8_t *)strInt,16);
      }
      break;
    }
